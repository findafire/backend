...
FIRE_DIRECTORY_URL_TERRA = 'http://e4ftl01.cr.usgs.gov/MOLT/MOD14A1.005/'
FIRE_DIRECTORY_URL_AQUA = 'http://e4ftl01.cr.usgs.gov/MOLA/MYD14A1.005/'
...
def fetch_last_added_data():
    fetch_last_added_satellite_data(FIRE_DIRECTORY_URL_AQUA, 'tmp-aqua')
    fetch_last_added_satellite_data(FIRE_DIRECTORY_URL_TERRA, 'tmp-terra')
